/**
 */
package io.github.sekassel.moea.model.cra.util;
 ...
 * @generated
 */
public class CraSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CraPackage.CLASS: {
				io.github.sekassel.moea.model.cra.Class class_ = (io.github.sekassel.moea.model.cra.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = caseNamedElement(class_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CraPackage.ATTRIBUTE: {
	 ...
	 * @generated
	 */
	public T caseClass(io.github.sekassel.moea.model.cra.Class object) {
		return null;
	}
